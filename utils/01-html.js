...
// set the assignment
let assignment = assignments.html,
    { baseDir } = assignments;
...
classroom.initOcto (token);
  ...
  // await classroom.updateFilesAllBranches (assignment, baseDir, ['package.json'], branchList );
  await classroom.pushAllBranches (assignment,baseDir);
