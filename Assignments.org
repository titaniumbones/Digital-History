...
:EXPORT_FILE_NAME: comment-participation
:END:
...
:POST_DATE: [2015-12-11 Fri 11:16]
:EXPORT_FILE_NAME: assignments-01-and-02-html-&-css-self-study-+-javascript-intro
:END:
...
:PROPERTIES:
:EXPORT_FILE_NAME: assignment-03-spatial-history
...
:EXPORT_FILE_NAME: assignment-04-oral-history
:END:
