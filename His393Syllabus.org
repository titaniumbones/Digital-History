...
| DOM and Data         | <2019-10-29 Tue>  | Programming Concepts: Object structure, substitution, text as data | \checkmark | \checkmark | \checkmark |   |
| DOM and Data Extras  |          |                                                                    | \checkmark |   |   |   |
| Spatial History      | <2019-11-07 Thu>  | API's, GIS                                                         | \checkmark | \checkmark |   |   |
| Oral History         | <2018-11-29 Thu>  | API's, Multimedia Narratives                                       | \checkmark | \checkmark | \checkmark | \checkmark |
| Project Proposal     | <2019-12-05 Thu>  | Imagine a Digital History Project                                  | \checkmark |   |   |   |
|----------------------+----------+--------------------------------------------------------------------+---+---+---+---|
|                      |          |                                                                    |   |   |   |   |
