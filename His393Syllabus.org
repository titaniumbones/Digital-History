...
* COMMENT DETAILS Summer 2020 
- Class is May 4 to June 15
- gh classroom invite link: https://classroom.github.com/classrooms/63257651-his393-digital-history-summer-2020
...
This class is being taught online and largely asynchronously for the first time during lockdown in May/June 2020. Ironically,the class has traditionally relied heavily on face to face interactions. This term, lectures will *all* be delivered asynchronously, and scheduled classtime -- 6 hours per week -- will be devoted to practical coding and writing problems. Essentially, this is a [[https://www.teachthought.com/learning/the-definition-of-the-flipped-classroom/][flipped classroom]] approach, but one in which we never meet IRL. 
...
|----------------------+----------+--------------------------------------------------------------------+---+---+---+---|
| Class Profile        | <2020-05-06 Wed>  | version control and collaboration                                  | \checkmark | \checkmark | \checkmark | \checkmark |
| G & GH Extras        |          |                                                                    | \checkmark |   |   |   |
| Zero to Blog Post    | <2020-05-15 Fri>  | web markup and presentation                                        | \checkmark | \checkmark | \checkmark | \checkmark |
| Z2B Extras           |          |                                                                    | \checkmark |   |   |   |
| A Feast of Ministers | <2020-05-22 Fri>  | Programming Concepts: abstraction, loops, data types               | \checkmark | \checkmark | \checkmark | \checkmark |
| Ministers Extras     |          |                                                                    | \checkmark |   |   |   |
| DOM and Data         | <2020-05-29 Fri>  | Programming Concepts: Object structure, substitution, text as data | \checkmark | \checkmark | \checkmark |   |
| DOM and Data Extras  |          |                                                                    | \checkmark |   |   |   |
| Spatial History      | <2020-06-03 Wed>  | API's, GIS                                                         | \checkmark | \checkmark |   |   |
| Oral History         | <2020-06-12 Fri>  | API's, Multimedia Narratives                                       | \checkmark | \checkmark | \checkmark | \checkmark |
| Project Proposal     | <2020-06-17 Wed>  | Imagine a Digital History Project                                  | \checkmark |   |   |   |
|----------------------+----------+--------------------------------------------------------------------+---+---+---+---|
|                      |          |                                                                    |   |   |   |   |
#+TBLFM: 
...
:END:
*** ({{{ts}}}) Introducing /Digital History/, [[https://github.com][Github]], and [[https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet][Markdown]] 
:PROPERTIES:
...
*** ({{{ts}}}) What the Web Signifies + [[https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/HTML_basics][HTML]] and [[https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/CSS_basics][CSS]] 
...
- Cohen, Daniel J. “[[http://jah.oxfordjournals.org.myaccess.library.utoronto.ca/content/95/2/452.short][Interchange: The Promise of Digital History]]” 95, no. 2 (September 1, 2008): 452–91. 
...
*** ({{{ts}}}) Distant Reading 2: Are Texts Data? 
...
*** ({{{ts}}}) Text as Data, History as Algorithm 
...
*** ({{{ts}}}) Computing Concepts & Assignment Help Catch-up day  
...
*** ({{{ts}}}) What's Special about Oral History 
...
*** ({{{ts}}}) Project Planning & Citizen History  
...
# org-mwp-classtimes-calibrate: ("<2020-04-30 Thu>" "<2020-04-28 Tue>" )
# End:  
