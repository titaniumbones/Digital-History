...
:END:
*** Introducing /Digital History/, [[https://github.com][Github]], and [[https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet][Markdown]] ({{{ts}}})
:PROPERTIES:
...
*** What the Web Signifies + [[https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/HTML_basics][HTML]] and [[https://developer.mozilla.org/en-US/docs/Learn/Getting_started_with_the_web/CSS_basics][CSS]] ({{{ts}}})
...
*** Computing Concepts & Assignment Help Catch-up day ({{{ts}}}) 
