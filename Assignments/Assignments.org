...
*Or:* If you like, you are more than welcome to login to your github account, fork the repository, and push your changes to the web; if you do that, then all you need to do is send me the URL of your new repository, or if you like, submit a pull request which I can inspect.
** Learning Objectives
