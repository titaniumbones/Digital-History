...
If you want to code, you have to write like a coder. This means using a powerful text editor. In this class we use [[https://code.visualstudio.com/][Visual Studio Code]]. Please follow the download links and install to your computer. There's a [[../using-vscode][separate post about using VSCode]] -- once you've installed it, navigate there!
...
*IMPORTANT UPDATE*: VSCode has an [[https://code.visualstudio.com/docs/editor/integrated-terminal][integrated terminal]], and it's extremely useful. Windows users will have to do a little bit of work in order to use bash in the integrated terminal. See the excellent [[https://code.visualstudio.com/docs/editor/integrated-terminal#%5Fconfiguration][terminal configuration instructions online]], and be sure to follow the link explaining [[https://code.visualstudio.com/docs/getstarted/settings#%5Fcreating-user-and-workspace-settings][how to access the user settings screen in VSCode]].
...
VSCode also has an interface to Git and Github. It's pretty powerful and intuitive, so I recommend trying it before installing GitKraken. [[https://code.visualstudio.com/docs/editor/versioncontrol#%5Fgit-support][The instructions are here]].
...
* using vscode
   :PROPERTIES:
   :CUSTOM_ID: using-vscode-10
   :EXPORT_FILE_NAME: using-vscode
   :END:

Microsoft's [[https://code.visualstudio.com/][Visual Studio Code]] is an amazing general-purpose code editor. Most people I collaborate with use it as their primary editor, and that will be true in most professional settings you enter. This is the first year we're using it in the class, and I have some high hopes for it.

As with any powerful tool, it can take a little while to get comfortable with VSCode. The [[https://code.visualstudio.com/docs][documentation]] is excellent, but may sometimes assume more advanced programming skills than you have. The [[https://code.visualstudio.com/docs/getstarted/introvideos][videos]] are also excellent and recommended.

I will mostly let you explore on your own, but here are a few important starting points.

** Editor Basics
   :PROPERTIES:
   :CUSTOM_ID: editor-basics-editor-basics
   :END:
...
Finally, it's important to mention the [[https://code.visualstudio.com/docs/getstarted/userinterface#%5Fcommand-palette][Command Palette]]. This is a magic bar that opens up in the top center of the screen when you type =F1= or =Control-Shift-P= (=Command-Shift-P= on a Mac). This gives you rapid access to many, many commands, and we'll use it a lot.

Read more about the [[https://code.visualstudio.com/docs/getstarted/userinterface][user interface here]].
...
1. Install Node and NPM as per [[../setup/#node-and-npm-this-is-the-hardest-part][this section of the "Setup" instructions]] 
2. From the command line, navigate to the root directory of your repository using ~cd~ as per [[https://digitalhistory.github.io/tools/navigating-command-line/][the navigation help page]]
3. From the root directory of your repository,type the following command into the terminal/git-bash prompt: ~npm install~. Alternatively, if you have the VSCode extensions installed, you can run ~
...
:PROPERTIES:
:EXPORT_FILE_NAME: assignment-git-tips
:END:
...
#+end_src
For an explanation of these commands, you can [[https://hints.binaryage.com/how-to-remove-ds-store-files-from-a-git-repo/][look at random posts o n the Internet]], [[https://stackoverflow.com/questions/107701/how-can-i-remove-ds-store-files-from-a-git-repository][ask Stackoverflow]], or read the official manuals (at least on MacOS) by typing ~man find~, ~man xargs~, ~man echo~, and ~man gitignore~. A lot of those explanations will be kind of complicated, though, especially the (insanely complicated) ~find~ manual.  
...
** Deprecated detailed instructions -- DON'T FOLLOW THESE UNLESS SOMETHING HAS GONE TERRIBLY WRONG
...
- update ~package.json~ so that it's exactly the same as mine.  You really don't want there to be even 1 character of difference, or git might be mad at you.  [[https://raw.githubusercontent.com/DigitalHistory/assignment-01-html-css/master/package.json][Here's my current version]], and [[https://github.com/DigitalHistory/assignment-01-html-css/blob/master/package.json][here it is in the Github web interface]].
...
5. Add a new piece of history *from inside Github itself(!)* by following the direction in the README under ~Contributing~.
   ...
   [[http://digitalhistory.github.io/wp-content/uploads/2017/01/wpid-create-file.jpeg]]

6. *Important!* You'll be given a choice between “Committing directly to master” and “Creating a new branch”. Choose the latter option and then follow the instructions to submit a pull request. Amazing! [[http://digitalhistory.github.io/wp-content/uploads/2017/01/wpid-commit-options.png]]
...
** COMMENT Using Github Desktop (GHD)
   :PROPERTIES:
...
2. Add your directory to atom as a “project directory:
   [[http://digitalhistory.github.io/wp-content/uploads/2016/01/wpid-githb-add-project.png]]
3. Install the “git-plus” package in Atom
4. Create a new file in the appropriate place.
5. Choose menu item =Packages \rightarrow Git Plus \rightarrow Add=, then
   =Packages \rightarrow Git Plus \rightarrow Commit=, then
   =Packages \rightarrow Git Plus \rightarrow Push=
...
*** COMMENT not sure why all these links are here. 
- [[https://digitalhistory.github.io/03-spatial-history/][Assignment 03: Spatial History]]
- [[https://digitalhistory.github.io/04-oral-history/][Assignment 04: Oral History]]
- [[https://digitalhistory.github.io/assignment-05-project-proposal/][Assignment  05: Project Proposal]]
- [[https://digitalhistory.github.io/assignments/][Assignments]]
- [[https://digitalhistory.github.io/01-web-skills/][Assignments 01 and  02: HTML & CSS self-study]]
- [[https://digitalhistory.github.io/basic-js-part-2-the-dom/][Basic JS
  Part 2: the DOM]]
- [[https://digitalhistory.github.io/][Digital History: His389, Winter 2017]]
- [[https://digitalhistory.github.io/distant-reading-2/][Distant  Reading 2]]
- [[https://digitalhistory.github.io/distant-reading-exercise-building-a-wordle/][Distant Reading Exercise: Building a Wordle]]
- [[https://digitalhistory.github.io/introducing-css/][Introducing CSS]]
- [[https://digitalhistory.github.io/introduction-to-github/][Introduction to Github!]]
- [[https://digitalhistory.github.io/javascript-basics-i-operators-loops-and-that-pesky-problem-1/][Javascript
  Basics I: Operators, Loops, and that Pesky Problem 1]]
- [[https://digitalhistory.github.io/learn-by-example-history-please/][Learn by example: History-Please]]
- [[https://digitalhistory.github.io/lecture-notes/][Lecture Notes]]
- [[https://digitalhistory.github.io/spatial-history-with-google-maps/][Spatial History with Google Maps]]
- [[https://digitalhistory.github.io/tools/][Tools]]

  - [[https://digitalhistory.github.io/tools/understanding-popcorn/][Understanding Popcorn]]
  - [[https://digitalhistory.github.io/tools/understanding-popcorn-2/][Understanding Popcorn]]

- [[https://digitalhistory.github.io/blogs/][Your Blogs]]
...
:PROPERTIES:
:EXPORT_FILE_NAME: wrong-repo-fix
:END:
Due perhaps to some outdated language somewhere in my course materials (sorry!) some of you appear to have accidentally *forked the template repo* rather than following the [[https://classroom.github.com/a/isSHhGpz][magic link to set things up the "official" way]]. Uh oh! Don't worry, this is easy to fix.  But *please do it soon* so I can grade all the assignments togetherHere/s are instructions for Assignment 0. If you've stumbled into this problem later in the semester, you'll need to adjust them as appropriate:

1. [[https://classroom.github.com/a/isSHhGpz][Click on this link]]. Your "proper" repo will be created, and *you will be shown a link to the new repository*.
...
- Browser consoles and scratchpads :: Your browser has a built-in "console" where you can enter javascript commands and see their output. See [[https://digitalhistory.github.io/tools/setup/#web-browser][the Setup doc]] for more info.
...
- Online Playgrounds :: These can be fantastic resources, but they make more sense for web-based programming. We may discuss these later in the course.  
...
* JS Cheatsheet
:PROPERTIES:
:EXPORT_FILE_NAME: js-cheat-sheet
:CANVASID: 317312
:CANVAS_PAGE_URL: js-cheatsheet
:OL_PUBLISH: nil
:CANVAS_HTML_URL: https://q.utoronto.ca/courses/123949/pages/js-cheatsheet
:CANVAS_SHORT_URL: js-cheatsheet
...
* COMMENT Reading /Eloquent Javascript/
...
- Open them up in your text editor

This will get you ready for your next assignment.
* COMMENT Javascript Error in Current Assignment!
:PROPERTIES:
...
- [[https://github.com/DigitalHistory/popcorn-js/blob/gmaps-update-api/plugins/figure/popcorn.figure.js][Figure]] lets you display an image. This adds a new parameter -- 'src' -- which let you select an image and also link that image to another location, if you so wish. (I haven't tested the linking os it may not be implemented yet).  
- [[https://github.com/mozilla/popcorn-js/tree/master/plugins/googlemap][Google Maps]] Creates a google map. There are a bunch of new parameters here, see our source code for more info.
- [[https://github.com/DigitalHistory/popcorn-js/blob/gmaps-update-api/plugins/leaflet/popcorn.leaflet.js][Leaflet Maps]] offers a slightly more familiar interface, though the problem with slow tile loading still persists.
- [[https://github.com/DigitalHistory/popcorn-js/blob/gmaps-update-api/plugins/markdown/popcorn.markdown.js][Markdown]] allows you to add markdown annotations
- [[https://github.com/DigitalHistory/popcorn-js/blob/gmaps-update-api/plugins/wikipedia/popcorn.wikipedia.js][Wikipedia]] will add the first few paragraphs from a Wikipedia page.
- [[https://github.com/DigitalHistory/popcorn-js/blob/gmaps-update-api/plugins/webpage/popcorn.webpage.js][Webpage]] will embed a webpage in an iframe
...
- alas, most of the old resources have been taken down in the past 2 years. All that's really left is the [[https://github.com/menismu/popcorn-js/][Github repo]] and [[https://menismu.github.io/popcorn-docs/][the docs website]],  and both have been derelict for about 6 months. You can see my changes in [[https://github.com/menismu/popcorn-js/pull/73][my main pull request]], and browse through [[https://github.com/menismu/popcorn-js/issues][the issues I've been submitting]], especially [[https://github.com/menismu/popcorn-js/issues/80][number 80]].
** CSS and Popcorn display issues
...
* COMMENT Adding a Custom Icon to Google Maps Markers 
:PROPERTIES:
...
** 
* COMMENT Ecosystem, Infrastructure, and Tools
:PROPERTIES:
