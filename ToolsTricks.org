...
- [[https://github.com/mozilla/popcorn-js/tree/master/plugins/image][Image]] lets you display an image. This adds two new parameters -- 'src' and 'href' -- which let you select an image and also link that image to another location, if you so wish.  
...
- it's possible you will also want to use others; of these the most likely to be of use is [[https://github.com/mozilla/popcorn-js/tree/master/plugins/wikipedia][Wikipedia]].
...
- alas, most of the old resources have been taken down in the past 2 months. All that's really left is the [[https://github.com/mozilla/popcorn-js/][Github repo]].
